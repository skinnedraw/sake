...
#include <string>
namespace Offsets {
    inline std::string ClientVersion = "version-8b8c34790f814a73";
    ...
    namespace FFlags {
        inline constexpr uintptr_t DebugDisableTimeoutDisconnect = 0x67c3730;
        inline constexpr uintptr_t EnableLoadModule = 0x67b90e8;
        inline constexpr uintptr_t PartyPlayerInactivityTimeoutInSeconds = 0x6781a70;
        inline constexpr uintptr_t TaskSchedulerTargetFps = 0x74d5644;
        inline constexpr uintptr_t WebSocketServiceEnableClientCreation = 0x67d04c8;
    }

    namespace FakeDataModel {
        inline constexpr uintptr_t Pointer = 0x7fa1988;
    ...
    namespace GuiObject {
        ...
        inline constexpr uintptr_t Image = 0xa10;
    ...
    namespace MouseService {
        ...
        inline constexpr uintptr_t SensitivityPointer = 0x8001970;
    }
    ...
    namespace PlayerConfigurer {
        ...
        inline constexpr uintptr_t Pointer = 0x7f7fce8;
    }
    ...
    namespace TaskScheduler {
        ...
        inline constexpr uintptr_t Pointer = 0x8057e48;
